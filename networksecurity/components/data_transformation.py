...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''
        It initializes a KNN Imputer object with the parmaeters specified in training_pipeline.py
        file and returns a pipeline object with the KNN Imputer as the first step
        '''
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        logging.info("Entered Data Transformation Inititation")
        try:
            ...
            # From 1 -1 convert the target feature to 1 0
