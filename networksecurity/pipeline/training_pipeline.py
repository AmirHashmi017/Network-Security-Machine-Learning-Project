...
class TrainingPipeline:
    ...
    def start_data_transformation(self,data_validation_artifact:DataValidationArtifact):
        try:
            ...
            logging.info(f"Data Validation Completed and artifact: {data_transformation_artifact}")
            return data_transformation_artifact
        except Exception as e:
            raise NetworkSecuityException(e,sys)
    
    def start_model_trainer(self,data_transformaion_artifact:DataTransformationArtifact):
        try:
            model_trainer_config= ModelTrainerConfig(self.training_pipeline_config)
            model_trainer=ModelTrainer(model_trainer_config,data_transformaion_artifact)
    ...
    # Local Artifact getting pushed to s3 Bucket
